...
libraryDependencies ++= Seq(
  "org.typelevel" %% "scodec-bits" % "1.0.4-SNAPSHOT",
...
binaryIssueFilters ++= Seq(
  ...
  ProblemFilters.exclude[MissingMethodProblem]("scodec.Codec.narrow"),
  ProblemFilters.exclude[MissingMethodProblem]("scodec.Codec.widen"),
  ProblemFilters.exclude[MissingMethodProblem]("scodec.Decoder.asDecoder"),
  ProblemFilters.exclude[MissingMethodProblem]("scodec.Decoder.decodeOnly"),
